...
def valorDiagonal(matriz):
  ...
  linhas = len(matriz)#linha recebe a quantidade de linha da coluna
  indLinhas = 0 #inicializa a variavel indLinhas
  indCoef = 0   #inicializa a variavel indCoef
  nrCoef = len(matriz[0])  
...
abre_arquivo('./escalonamento.txt')
